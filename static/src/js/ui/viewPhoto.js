 ...
 */
 define(["jquery","paths"], function($,path) {
 	...
 	function a(a) {
 		var c = $(a).attr("href"),
 			h = ($('<div id="js-imgview-mask" class="imgview-mask"></div>').appendTo($("body")).fadeIn(), $('<div id="js-imgview" class="show-img"><img id="bigimage" class="imgplacHolder" src="'+ path.static +'/static/src/img/loading/rjsAjaxloading.gif"><a href="#" class="imgview-close" ></a></div>').appendTo($("body"))),
 			v = new Image;
	 		v.onload = function() {
