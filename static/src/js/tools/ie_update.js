   document.body.innerHTML = "";
    ...
    html += '<a href="http://www.firefox.com.cn/" style="background-image:url(http://wufff.static.dev.dodoedu.com/ncjxdPage/static/src/img/logo_bloor.png);padding-left:75px;display:inline-block;height:70px;background-position: 0 -72px;line-height:70px;color:#f5584c;background-repeat: no-repeat;">火狐浏览器 </a> 。</p>';
