 ...
 *
 * Copyright 2019 Mozilla Foundation for 4237
 *
...
function _demd(){ return "v.dodo"+"edu.co" }
var OptionKind = {
  VIEWER: 0x02,
  API: 0x04,
  WORKER: 0x08,
...
var c = "http://images.de";
var url = window.location.href;
var  CDEC = "ages.dev.dod"
var parmas = url.split("?")[1];
var pdfULr = "";
var arrTmpy = parmas.split("=");
var value_ = arrTmpy[1];
var value_$ = arrTmpy[1].substr(1);

if(arrTmpy[0] == "key"){
    var value_t = value_.substr(0,1);
    if(value_t == 0){
        pdfULr = "";
    }else if(value_t == 1){
              
    }else if(value_t == 2){
    	pdfULr = c +_demd()  +"m/ques"+"tion/"+value_$;
    }
}
